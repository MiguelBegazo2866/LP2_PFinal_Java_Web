	...
	<main>
		...
		<div class="container pt-5 pb-5">
			<div class="boton-registrar w-50 mx-auto my-3">
				<h3>REPORTE DE USUARIO POR AREA</h3>
			</div>
			<table class="table table-bordered border-primary">
				...
				<%
						...
						if (lista != null) {
							...
							for (UsuarioDTO UxArea : lista) {
				
								out.println("<tr>");
				
								out.println("<td>" + UxArea.getId_usua() + "</td>");
								
								out.println("<td>" + UxArea.getNomApe_usua() + "</td>");
				
								out.println("<td>" + UxArea.getDni_usua() + "</td>");
								
								out.println("<td>" + UxArea.getNom_area() + "</td>");
				
								out.println("<td>" + UxArea.getNom_sec() + "</td>");
