	...
	<main>
		<div class="container pt-5 pb-5">
			<div class="boton-registrar w-25 mx-auto my-3">
				<a class="btn btn-success w-100" href="registrarIncidente.jsp">Nuevo Incidente</a>
			</div>
			<table class="table table-bordered border-success">
				...
				<%
						ArrayList<IncidenteDTO> lista = (ArrayList<IncidenteDTO>) request.getAttribute("data");
			
						if (lista != null) {
				
							for (IncidenteDTO xInc : lista) {
				
								out.println("<tr>");
				
								out.println("<td>" + xInc.getId_inc() + "</td>");
				
								out.println("<td>" + xInc.getNom_inc() + "</td>");
								
								out.println("<td>" + xInc.getNom_tipo() + "</td>");
				
								out.println("<td>" + xInc.getNom_cat() + "</td>");
				
								out.println("<td align='center'><a href='ServletIncidente?tipo=buscar&cod=" + xInc.getId_inc()
								
								+ "'><img src='images/edit.png' title='Editar'></a></td>");
				
								out.println("<td align='center'><a href='ServletIncidente?tipo=eliminar&cod=" + xInc.getId_inc()
