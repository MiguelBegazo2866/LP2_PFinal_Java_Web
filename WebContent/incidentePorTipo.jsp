	...
	<main>
		<div class="container pt-5 pb-5">
			<div class="boton-registrar w-50 mx-auto my-3">
				<h3>Reporte de Incidente por Tipo</h3>
			</div>
			<table class="table table-bordered border-success">
				...
				<%
						...
						if (lista != null) {
							...
							for (IncidenteDTO InxTip : lista) {
				
								out.println("<tr>");
				
								out.println("<td>" + InxTip.getId_inc() + "</td>");
				
								out.println("<td>" + InxTip.getNom_inc() + "</td>");
								
								out.println("<td>" + InxTip.getNom_tipo() + "</td>");
				
								out.println("<td>" + InxTip.getNom_cat() + "</td>");
