	...
	<main>
		<div class="container pt-5 pb-5">
			<div class="boton-registrar w-25 mx-auto my-3">
				<a class="btn btn-danger w-100" href="registrarResponsable.jsp">Nuevo Responsable</a>
			</div>
			<table class="table table-bordered border-danger">
				...
				<%
						...
						if (lista != null) {
							...
							for (ResponsableDTO xResp : lista) {
				
								out.println("<tr>");
				
								out.println("<td>" + xResp.getId_resp() + "</td>");
								
								out.println("<td>" + xResp.getNomApe_resp() + "</td>");
				
								out.println("<td>" + xResp.getCod_resp() + "</td>");
				
								out.println("<td>" + xResp.getNom_cargo() + "</td>");
				
								out.println("<td>" + xResp.getNom_sec() + "</td>");
				
								out.println("<td align='center'><a href='ServletResponsable?tipo=buscar&cod=" + xResp.getId_resp()
								
								+ "'><img src='images/edit.png' title='Editar'></a></td>");
				
								out.println("<td align='center'><a href='ServletResponsable?tipo=eliminar&cod=" + xResp.getId_resp()
